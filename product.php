...
?>
               ...
               <div class="left-ads-display col-lg-9">
                  ...
                  <?php
                  $cid=$_GET['cid'];
$ret=mysqli_query($con,"select tblarttype.ID as atid,tblarttype.ArtType as typename,tblartproduct.ID as apid, tblartproduct.SellingPricing as price,tblartproduct.Title,tblartproduct.Image,tblartproduct.ArtType from tblartproduct join tblarttype on tblarttype.ID=tblartproduct.ArtType where tblartproduct.ArtType='$cid'");
$cnt=1;
                                    ...
                                    <div class="grid_meta">
                                       <div class="product_price">
                                          ...
                                          <h4 >
                                             ...
                                             <a href="single-product.php?pid=<?php  echo $row['apid'];?>" style="color:#000"><?php  echo $row['price'];?></a>
                                          </h4>
                                          <div class="product_price">
                                             <h4>
                                             <button class="btn btn-success"><a href="/agms/login-signup-form/login.php" style="color:#fff">Enquiry</a></button></h4>
                                          </div>
                                       </div>
