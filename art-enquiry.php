...
if(isset($_POST['send']))
  {
    ...
    $enquirynumber = mt_rand(100000000, 999999999);
      $eid=$_GET['eid'];
    $query1=mysqli_query($con,"insert into  tblenquiry(Artpdid,FullName,Email,MobileNumber,address,amount,EnquiryNumber) value('$eid','$fullname','$email','$mobilenumber','$address','$amount','$enquirynumber')");
        if ($query1) {
 echo '<script>alert("Your order successfully send. Your order number is "+"'.$enquirynumber.'")</script>';
   ...
   <body>
      ...
      <section class="contact py-lg-4 py-md-3 py-sm-3 py-3">
         <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
            <h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">checkout</h3>
            <div class="contact-list-grid">
               <form action=" " method="post">
                  <div class=" agile-wls-contact-mid">
                     ...
                     <div class="form-group contact-forms">
                       <textarea class="form-control" name="address" placeholder="address" required="true" rows="4"></textarea>
                     </div>
